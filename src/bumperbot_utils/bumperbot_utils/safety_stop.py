...
from twist_mux_msgs.action import JoyTurbo # action interface
...
class SafetyStop(Node):
    def __init__(self):
        ...
        # creating action clients for Turbo
        ...
        # waiting for action servers to be available
    ...
    def laser_callback(self, msg: LaserScan):
        ...
        if self.state != self.prev_state:
            ...
            if self.state == State.WARNING:
                ...
                # send the decrease speed action to the decrease speed server
                ...
                is_safety_stop.data = False
                # send the increase speed action to the increase speed server
