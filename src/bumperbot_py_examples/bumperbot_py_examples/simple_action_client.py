...
'''
ActionClient is used to send goals to an action server.

ActionClient.wait_for_server() is used to wait for the action server to be available.

ActionClient.send_goal_async() is used to send a goal to the action server.
